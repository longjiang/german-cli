      ...
      <div class="container">
        <div class="row mb-4">
          <div class="col-sm-12">
            <router-link to="/">
              <img
                src="/img/logo-de-zth-light.png"
                alt="German Zero to Hero"
                class="logo"
              />
            </router-link>
          </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-12">
            ...
            <p>
              <b>Credits:</b> German-English dictionary data from
              <a href="https://en.freedict.org">freedict.org</a>, licensed
              under
